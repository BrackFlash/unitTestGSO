...
public class ContactTest {
	...
	/**
	 * Tests if the constructor works properly Checks the assignment of the
	 * name of the contact
	 */
	@Test
	...
	/**
	 * Testing the add method of the contact/appointment class. First case:
	 * the person has no appointments. An appointments should be added to
	 * the agenda of the person Second case: the appointment timespan
	 * intersects. The method should return false. Third case: an
	 * appointment is added because the appointment doesn't intersect with
